...
This library provides a simple, reactive, and thread-safe interface to communicate with STOMP brokers over WebSockets using OkHttp directly as the WebSocket engine.
